...
<script>
    ...
    $('#create-form').validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                url: "${createLink(controller: 'returnNewProduct', action: 'save')}",
                type: 'post',
                dataType: "json",
...
//            "bProcessing": true,
            ...
            "sAjaxSource": "${g.createLink(controller: 'returnNewProduct',action: 'list')}",
        ...
        $('#list-table').on('click', 'a.edit-reference', function (e) {
            ...
            jQuery.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: "${g.createLink(controller: 'returnNewProduct',action: 'edit')}?id=" + referenceId,
...
//                        $('#datepicker').val(data.obj.damageDate);
                        $('.datepicker').datepicker('setDate', new Date(data.obj.returnNewDate));
        ...
        $('#list-table').on('click', 'a.delete-reference', function (e) {
            ...
            if (confirmDel == true) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: "${g.createLink(controller: 'returnNewProduct',action: 'delete')}?id=" + referenceId,
                    success: function (data, textStatus) {
                        if (data.isError == false) {
